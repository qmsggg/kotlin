...
public class PackagePartCodegen extends MemberCodegen<KtFile> {
    ...
    protected void generateBody() {
        for (KtDeclaration declaration : CodegenUtil.getActualDeclarations(element, state.getBindingContext())) {
    ...
    protected static Pair<DescriptorSerializer, ProtoBuf.Package> serializePackagePartMembers(
        ...
        List<KtDeclaration> allDeclarations = CodegenUtil.getActualDeclarations(codegen.element, bindingContext);
