...
class ScriptingGradleProjectImportHandler : GradleProjectImportHandler {
    ...
    val gradlePluginJar = "scripting-gradle" // obsolete artifact name, only for compatibility with 1.2.5x, where it was introduced (and immediately dropped afterwards)
    // TODO: remove after some releases and simplify the code below
